...
export const metadata: Metadata = {
  ...
  description: 'Rushiraj Jadeja is a full-stack software developer and indie maker based in Ahmedabad, India. MS Computer Science from Cal State Fullerton. 7 years in USA. Creator of CashLens, PrivacyPage, InvoiceZen, StackRadar. Available for freelance.',
