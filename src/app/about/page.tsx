    ...
    <div className="min-h-screen">
      ...
      <section className="section">
        <div className="container max-w-3xl">
          ...
          <h2 className="heading-display font-heading text-3xl md:text-4xl mb-10">The journey so far</h2>
          <div className="space-y-0">
            {timeline.map((item, i) => (
              <motion.div
                ...
                className="flex gap-6 py-5 border-b border-[var(--border)] group"
              >
                <span className="text-[var(--accent)] font-mono text-sm w-16 shrink-0 pt-0.5 font-medium">{item.year}</span>
                <span className="text-[var(--text-secondary)] group-hover:text-[var(--text)] transition-colors">{item.text}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="section">
        <div className="container max-w-3xl">
          ...
          <h2 className="heading-display font-heading text-3xl md:text-4xl mb-8">5 AI agents on a Mac Mini</h2>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
      ...
      <section className="section">
        <div className="container max-w-3xl">
          ...
          <h2 className="heading-display font-heading text-3xl md:text-4xl mb-10">Things I care about</h2>
          <motion.div
            initial={{ opacity: 0 }}
      ...
      <section className="section">
        <div className="container max-w-3xl">
          ...
          <h2 className="heading-display font-heading text-3xl md:text-4xl mb-10">What I build with</h2>
