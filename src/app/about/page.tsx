          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-4">
              ...
              >
                ...
                <p>
                  I run 5 products — <a href="https://cashlens.app" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] hover-line">CashLens</a>, <a href="https://privacy.rushiraj.me" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] hover-line">PrivacyPage</a>, <a href="https://invoice.rushiraj.me" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] hover-line">InvoiceZen</a>, and <a href="https://deadby.rushiraj.me" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] hover-line">DeadBy.ai</a>. Zero VC money. Zero employees. Just me and 5 AI agents running 24/7 on a Mac in my room. That&apos;s the whole company.
                </p>
                <p>
