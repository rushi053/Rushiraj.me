...
export const metadata: Metadata = {
  ...
  description: 'Rushiraj Jadeja — full-stack developer and indie maker from Ahmedabad, India. MS Computer Science (CSUF). Building privacy-first software: CashLens, PrivacyPage, InvoiceZen, StackRadar, Cloudo, DeadBy.ai. Available for freelance & consulting.',
  ...
  openGraph: {
    ...
    description: 'Rushiraj Jadeja — full-stack developer from Ahmedabad, India. Building CashLens, PrivacyPage, InvoiceZen, StackRadar. MS CS from Cal State Fullerton.',
            ...
            __html: JSON.stringify([
              {
                ...
                description: 'Rushiraj Jadeja is a full-stack developer and indie maker from Ahmedabad, India. He builds privacy-first software including CashLens, PrivacyPage, InvoiceZen, StackRadar, Cloudo, and DeadBy.ai. MS Computer Science from Cal State Fullerton.',
                address: {
                  '@type': 'PostalAddress',
