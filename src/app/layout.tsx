...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Rushiraj Jadeja — full-stack developer from Ahmedabad, India. Building CashLens, PrivacyPage, InvoiceZen, Savvit. MS CS from Cal State Fullerton.',
            ...
            __html: JSON.stringify([
              {
                ...
                description: 'Rushiraj Jadeja is a full-stack developer and indie maker from Ahmedabad, India. He builds privacy-first software including CashLens, PrivacyPage, InvoiceZen, Savvit, and DeadBy.ai. MS Computer Science from Cal State Fullerton.',
                address: {
                  '@type': 'PostalAddress',
